...
set_unless[:ruby_enterprise][:version]      = '1.8.7-2010.02'
set_unless[:ruby_enterprise][:url]          = "http://rubyforge.org/frs/download.php/71096/ruby-enterprise-#{ruby_enterprise[:version]}"
